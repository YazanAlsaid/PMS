...
export class ClientReservationService {
  ...
  public createReservation(reservation: Reservation, buildingId: number, floorId: number, slotId: number): Observable<ResponseMessage> {
    return this.httpService.customRequest('/api/v1/web/reservations?buildingId=' + buildingId + '&floorId=' + floorId + '&slotId=' + slotId, reservation);
  }
